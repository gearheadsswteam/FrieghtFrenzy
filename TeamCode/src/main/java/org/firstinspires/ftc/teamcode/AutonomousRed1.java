...
public class AutonomousRed1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence traj4 = drive.trajectorySequenceBuilder(spinnerPose)
                ...
                .resetVelConstraint()
                .setTangent(PI / 2)
                .splineToSplineHeading(dropPose, 0.9)
