...
/**
 * https://github.com/PinkToTheFuture/OpenCV_FreightFrenzy_2021-2022/blob/main/OpenCV_Tutorial_Freight_Frenzy.java
 *
 */
    ...
    public void runOpMode()
    {
        ...
        webcam.openCameraDeviceAsync(new OpenCvCamera.AsyncCameraOpenListener()
        {
            ...
            public void onError(int errorCode) {
                telemetry.addData("Error in OPenCV with error code ", errorCode);
                telemetry.update();
        ...
        while (opModeIsActive())
        {
            ...
            if(myPipeline.getRectArea() > 2000){
                if(myPipeline.getRectMidpointX() > 400){
                    telemetry.addData("myPipeline.getRectMidpointX() : ", myPipeline.getRectMidpointX());
                    AUTONOMOUS_C();
                }
